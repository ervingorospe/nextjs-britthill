...
export async function ImageRightSmallerImage({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative overflow-hidden" bg={bg}>
      <Container width={width} margin="section" className="relative z-100">
        <Motion>
          <div className="mt-6 grid items-center lg:grid-cols-2 xl:grid-cols-12 lg:gap-12 xl:gap-16 2xl:gap-20">
            {
              fields.image && (
                <MotionVariant className="mx-auto relative xl:col-span-4" variants={fadeInFromBottom}>
                  <ImageHolder
                    image={fields.image} 
                    className={{
            ...
            <div className="relative z-10 xl:col-span-8 lg:row-start-1 mt-4 lg:mt-0">
              {/* title */}
              <Title
